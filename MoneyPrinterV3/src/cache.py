...
def get_accounts() -> List[dict]:
    """
    Gets the YouTube accounts from the cache.

    Returns:
        accounts (List[dict]): The YouTube accounts
    """
    ...
    with open(cache_path, 'r') as file:
        ...
        if parsed is None or 'accounts' not in parsed:
            return []
...
def add_account(account: dict) -> None:
    """
    Adds a YouTube account to the cache.
...
def remove_account(account_id: str) -> None:
    """
    Removes a YouTube account from the cache.
